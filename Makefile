...
MAIN = src/main.o
SOURCES = Game Script BulletManager Bullet SpriteBatch Read SubStream Scene Repository Config Utils Control ExclusiveSpeaker Signal
SCENES = TestScene PlainScene
CONTROLS = Builder Panel TextBox Bopper
